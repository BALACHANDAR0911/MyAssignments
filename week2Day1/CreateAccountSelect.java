package week2Day1;
	...
	public class CreateAccountSelect {
		...
		public static void main(String[] args) {
			...
			driver.findElement(By.id("accountName")).sendKeys("Balachandar S");
		...
		String text = driver.findElement(By.linkText("Balachandar S")).getText();
			System.out.println(text);
			if(text.contains("Balachandar S"))
