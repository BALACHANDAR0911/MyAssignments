package week2Day2;
	...
	public class EditLead {
		...
		ChromeDriver driver=new ChromeDriver();
			...
			driver.findElement(By.xpath("//*[@id=\"createLeadForm_firstName\"]")).sendKeys("Balachandar");
			driver.findElement(By.xpath("//*[@id=\"createLeadForm_lastName\"]")).sendKeys("S");
			driver.findElement(By.xpath("//*[@id=\"createLeadForm_firstNameLocal\"]")).sendKeys("Balachandar S");
			...
			driver.findElement(By.xpath("//*[@id=\"createLeadForm_primaryEmail\"]")).sendKeys("balachandar09s11@gmail.com");
