package week2Day2;
	...
	public class CheckBox {
		...
		public static void main(String[] args) throws InterruptedException {
			...
			driver.findElement(By.xpath("//div[contains(@class,'ui-chkbox-box ui-widget')]")).click();      //clicking basic checkbox
			driver.findElement(By.xpath("//*[@id=\"j_idt87:j_idt91\"]/div[2]")).click();                   //clicking notification checkbox
			driver.findElement(By.xpath("//*[@id=\"j_idt87:basic\"]/tbody/tr/td[1]/div/div[2]")).click();  //clicking favorite language.
